        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <button type="button" class="btn btn-warning shadow-none" data-bs-toggle="modal"
                    data-bs-target="#add_product"><i class="bx bx-plus"></i> Add Product</button>
                <!-- Modal Add Product -->
                        ...
                        <div class="modal-content">
                            ...
                            <form action="./akses.php" method="POST" enctype="multipart/form-data" autocomplete="off">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" name="add_produk"
                                        class="btn btn-success shadow-none">Add</button>
                                </div>
                            </form>
                        </div>
                    </div>
                ...
                <!-- Service -->
                <button type="button" class="btn btn-warning shadow-none" data-bs-toggle="modal"
                    data-bs-target="#add_service"><i class="bx bx-plus"></i> Add Service</button>
                <!-- Modal Add Service -->
            ...
            <div class="col-md-12 mt-5">
                <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="product-tab" data-bs-toggle="pill" data-bs-target="#product"
                            type="button" role="tab" aria-controls="product" aria-selected="true">Product List</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="service-tab" data-bs-toggle="pill" data-bs-target="#service"
                            type="button" role="tab" aria-controls="service" aria-selected="false">Service List</button>
                    </li>
                </ul>
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <?php
                                            if ($product_row['jumlah_product'] < 1) {
                                            ?>
                                    <td>0</td>
                                    <?php
                                            } else {
                                    ...
                                    <?php
                                            ...
                                            ?>
                                    <td><img src="./vendor/img/product_service/<?= $product_row['image_product']; ?>"
                                            width="50" class="rounded-5"></td>
                                    <?php
                                            } else {
                                            ?>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-success shadow-none" data-bs-toggle="modal"
                                            data-bs-target="#edit_product<?= $product_row['id_product']; ?>"><i
                                                class="bx bx-edit"></i></button>
                                        <!-- Modal Edit Product -->
                                        <div class="modal fade" id="edit_product<?= $product_row['id_product']; ?>"
                                            tabindex="-1">
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                    ...
                                                    <form action="./akses.php" method="POST"
                                                                ...
                                                                <div class="row justify-content-center">
                                                                    ...
                                                                    <div class="col-md-12">
                                                                        ...
                                                                        <input type="text" name="nm_product"
                                                                            ...
                                                                            value="<?= $product_row['nama_product']; ?>">
                                                                    </div>
                                                                    <div class="col-md-12 mt-2">
                                                                        <label class="form-label fw-bold">Jumlah
                                                                            Product</label>
                                                                        <input type="number" name="jml_product"
                                                                            class="form-control shadow-none"
                                                                            value="<?= $product_row['jumlah_product']; ?>"
                                                                            min="1">
                                                                    </div>
                                                                    <div class="col-md-12 mt-2">
                                                                        <label class="form-label fw-bold">Harga
                                                                            Product</label>
                                                                        <input type="text" name="hrg_product"
                                                                            class="form-control shadow-none"
                                                                            value="<?= $product_row['harga_product']; ?>">
                                                                    </div>
                                                                    <div class="col-md-12 mt-2">
                                                                        <label class="form-label fw-bold">Deskripsi
                                                                            Product</label>
                                                                        <textarea name="desk_product"
                                                                            class="form-control shadow-none"><?= $product_row['desk_product']; ?></textarea>
                                                                    </div>
                                                                    <div class="col-md-12 mt-2">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <button type="submit" name="edit_product"
                                                                class="btn btn-success shadow-none">Edit</button>
                                                        </div>
                                                    </form>
                                                </div>
                                            </div>
                                        ...
                                        <button type="button" class="btn btn-danger shadow-none" data-bs-toggle="modal"
                                            data-bs-target="#delete_product<?= $product_row['id_product']; ?>"><i
                                                class="bx bx-trash"></i></button>
                                        <!-- Modal Delete Product -->
                                        <div class="modal fade" id="delete_product<?= $product_row['id_product']; ?>"
                                            tabindex="-1">
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                    ...
                                                    <form action="./akses.php" method="POST"
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <button type="submit" name="delete_product"
                                                                class="btn btn-success shadow-none">Yes</button>
                                                        </div>
                                                    </form>
                                                </div>
                                            </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-success" data-bs-toggle="modal"
                                            data-bs-target="#edit_service<?= $product_row['id_product']; ?>"><i
                                                class="bx bx-edit"></i></button>
                                        <!-- Modal Edit Service -->
                                        <div class="modal fade" id="edit_service<?= $product_row['id_product']; ?>"
                                            tabindex="-1">
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                            ...
                                                            <div class="container">
                                                                <div class="row justify-content-center">
                                                                    ...
                                                                    <div class="col-md-12">
                                                                        <label class="form-label fw-bold">Nama
                                                                            Service</label>
                                                                        <input type="text" name="nm_service"
                                                                            class="form-control shadow-none"
                                                                            value="<?= $product_row['nama_product']; ?>">
                                                                    </div>
                                                                    <div class="col-md-12 mt-2">
                                                                        <label class="form-label fw-bold">Harga
                                                                            Service</label>
                                                                        <input type="text" name="hrg_service"
                                                                            class="form-control shadow-none"
                                                                            value="<?= $product_row['harga_product']; ?>">
                                                                    </div>
                                                                    <div class="col-md-12 mt-2">
                                                                    ...
                                                                    <div class="col-md-12 mt-2">
                                                                        <label class="form-label fw-bold">Image
                                                                            Service</label>
                                                                        <input type="file" name="img_service"
                                                                            class="form-control shadow-none">
                                                                    </div>
                                                                </div>
                                                            </div>
                                        ...
                                        <button type="button" class="btn btn-danger shadow-none" data-bs-toggle="modal"
                                            data-bs-target="#delete_service<?= $product_row['id_product']; ?>"><i
                                                class="bx bx-trash"></i></button>
                                        <!-- Modal Delete Service -->
                                        <div class="modal fade" id="delete_service<?= $product_row['id_product']; ?>"
                                            tabindex="-1">
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    <div class="modal-header">
